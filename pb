...
sed -i "s|docker-compose.yml|/home/$(whoami)/palworld-wine/docker-compose.yml|g" regular_maintenance.sh
...
sed -i -e '$a\\n# 서버 재시작' \
       ...
       /home/$(whoami)/palworld-wine/timer.sh
